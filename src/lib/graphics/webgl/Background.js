...
void main() {
    ...
    float scaledTime = (time * scale * 0.0000001) + 10.0;

    vec3 color1 = vec3(0.4 + 0.6 * tan(scaledTime / dist1), 0.4 + 0.6 * sin(scaledTime / dist1), 0.4 + 0.6 * cos(scaledTime / dist1));
    vec3 color2 = vec3(0.4 + 0.6 * tan(scaledTime / dist2), 0.4 + 0.6 * sin(scaledTime / dist2), 0.4 + 0.6 * cos(scaledTime / dist2));
    vec3 color3 = vec3(0.4 + 0.6 * tan(scaledTime / dist3), 0.4 + 0.6 * sin(scaledTime / dist3), 0.4 + 0.6 * cos(scaledTime / dist3));
    vec3 color4 = vec3(0.4 + 0.6 * tan(scaledTime / dist4), 0.4 + 0.6 * sin(scaledTime / dist4), 0.4 + 0.6 * cos(scaledTime / dist4));
    vec3 color5 = vec3(0.4 + 0.6 * tan(scaledTime / dist5), 0.4 + 0.6 * sin(scaledTime / dist5), 0.4 + 0.6 * cos(scaledTime / dist5));
    vec3 color6 = vec3(0.4 + 0.6 * tan(scaledTime / dist6), 0.4 + 0.6 * sin(scaledTime / dist6), 0.4 + 0.6 * cos(scaledTime / dist6));
    vec3 color7 = vec3(0.4 + 0.6 * tan(scaledTime / dist7), 0.4 + 0.6 * sin(scaledTime / dist7), 0.4 + 0.6 * cos(scaledTime / dist7));
    vec3 color8 = vec3(0.4 + 0.6 * tan(scaledTime / dist8), 0.4 + 0.6 * sin(scaledTime / dist8), 0.4 + 0.6 * cos(scaledTime / dist8));
